...
>>>>>>> 605a9f9d3e0805a86b49156b380e7edc94f5f91c
  ...
  async signUp(email, password, userData = {}) {
    ...
    try {
      ...
      // Complete onboarding immediately (no verification needed)
      await this.completeOnboarding(userData);
      
      this.hideAuthLoading();
      this.showAuthSuccess('Account created successfully! Welcome to PacksList.');
...
<<<<<<< HEAD
    ...
    console.log('✅ requireAdmin: User exists:', this.user.email);
    
    // Check if profile exists
    if (!this.userProfile) {
      console.log('❌ requireAdmin: No user profile found');
      return false;
    }
    console.log('✅ requireAdmin: User profile exists, role:', this.userProfile.role);
